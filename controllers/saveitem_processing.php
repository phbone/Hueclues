...
if ($code != "" && $desc != "") { // all fields filled in 
    ...
    if ($photo_file_type == "url" && $url_origin == "0") { // native url
        ...
        database_insert("item", "itemid", "NULL", "userid", $userid, "urlid", $photo_urlid, "image_origin", "0", "code", $code, "description", $desc, "purchaselink", $purchaseLink, "time", $time);
        ...
        database_insert("item", "itemid", "NULL", "userid", $userid, "imageid", $photo_file_imageid, "image_origin", "3", "code", $code, "description", $desc, "purchaselink", $purchaseLink, "time", $time);
        $itemid = mysql_insert_id();
    }
