...
<div id='collapsedMenu'>
    ...
    <a href = '/logout.php' class = 'navigationImage'><i title = 'Logout' style = 'font-size:25px;text-decoration:none;color:#58595B;' class = 'icon-off'></i></a><br/>
</div>
</div>
</h1></div>
<a href=''></a>";
