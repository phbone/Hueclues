...
function formatNotification($notificationid) {
    ...
    if ($type == "0") {
        ...
        $message = "<a class='notificationBox' href='/item/$itemid'><img src='".$fromUser['picture']."' class='notificationPicture' />$fromUsername <br/> liked your item</a>";
    } else if ($type == "1") {
        ...
        $message = "<a class='notificationBox' href='/hue/$itemid'><img src='".$fromUser['picture']."' class='notificationPicture' />$fromUsername <br/> matched your item</a>";
    } else if ($type == "3") {
