...
<div id='condensedMenu' onclick='Redirect(\"/closet/" . $user['username'] . "\")' onmouseover='headerMenu(\"on\")' onmouseout='headerMenu(\"off\")'>
    ...
    <a href = '/faq' class = 'navigationImage'><i title = 'FAQ' style = 'font-size:25px;text-decoration:none;color:#58595B;' class = 'fa-question'></i> Logout</a>
    <a href = '/logout.php' class = 'navigationImage'><i title = 'Logout' style = 'font-size:25px;text-decoration:none;color:#58595B;' class = 'fa-power-off'></i> Logout</a>
</div>
</div>
</h1></div>
