...
if ($code != "" && $desc != "") { // all fields filled in 
    ...
    $_SESSION['save_notification'] = "<span id='success_message'>Item successfully added to closet!<br/><a href='/closet'><img src='/img/hanger.png' style='height:20px;'></img></a></span>";
} else if ($code == "") {
    $_SESSION['save_notification'] = "<span id='error_message'>Please select an item color by clicking the uploaded image.</span><br/><br/>";
} else if ($desc == "") {
    $_SESSION['save_notification'] = "<span id='error_message'>Please describe the item in the space provided.</span><br/><br/>";
}
