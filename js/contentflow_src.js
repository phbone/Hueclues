 ...
 * ============================================================
 */
// global variable to keep track of the element being dragged
var globalFlowElement;
...
var ContentFlowGlobal = {
    ...
    init: function () {
        ...
        // set the global variable to the content flow element
        globalFlowElement = this;
        /* ================================================================== */
...
ContentFlow.prototype = {
    ...
    _defaultConf: { 
        ...
        reflectionColor: "none", // none, transparent or hex RGB CSS style #RRGGBB
