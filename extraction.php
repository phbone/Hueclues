    ...
    <body>
        ...
        <div id="extraction_container" style="display:none">
            ...
            <div class="well form-vertical" id="saveForm">
                ...
                <button id="saveform_button" class="greenButton" style="height: 74px;margin-top: 8px;width: 104px;padding: 5px;position: absolute;left: 296px;top: -8px;font-size: 20px;" onclick="saveItem()">SAVE TO CLOSET</button>
            </div>
